...
export default function Contact() {
    ...
    return (
        <section id="contact" className="py-12 relative z-10">
            <div className="max-w-7xl 2xl:max-w-[90rem] mx-auto flex flex-col md:flex-row gap-12 sm:gap-16 md:gap-24">
                ...
                <motion.div
                    ...
                    className="flex-1"
                >
                    <h2 className="text-4xl sm:text-5xl md:text-7xl 2xl:text-8xl font-bold tracking-tighter mb-6 sm:mb-8 text-accent">
                        Let's build something <span className="text-gray-500">meaningful.</span>
                    </h2>

                    <p className="text-lg sm:text-xl text-gray-400 mb-8 sm:mb-12 max-w-lg leading-relaxed">
                    ...
                    <div className="flex gap-3 sm:gap-4 mb-8 sm:mb-12 flex-wrap">
                    ...
                    <form ref={formRef} onSubmit={handleSubmit} className="space-y-6">
                        <div className="group relative">
                            <input
                                ...
                                placeholder="Name"
                                className="w-full bg-white/5 border border-white/10 p-3 sm:p-4 text-white placeholder-gray-400 focus:outline-none focus:border-accent focus:ring-1 focus:ring-accent focus:bg-white/10 transition-all rounded-lg peer text-sm sm:text-base"
                            />
                        </div>
                        ...
                        <div className="group relative">
                            <input
                                ...
                                onChange={handleChange}
                                placeholder="Email"
                                className="w-full bg-white/5 border border-white/10 p-3 sm:p-4 text-white placeholder-gray-400 focus:outline-none focus:border-accent focus:ring-1 focus:ring-accent focus:bg-white/10 transition-all rounded-lg text-sm sm:text-base"
                            />
                        </div>
                        ...
                        <div className="group relative">
                            <textarea
                                ...
                                rows="5"
                                placeholder="Message"
                                className="w-full bg-white/5 border border-white/10 p-3 sm:p-4 text-white placeholder-gray-400 leading-relaxed focus:outline-none focus:border-accent focus:ring-1 focus:ring-accent focus:bg-white/10 transition-all rounded-lg resize-none text-sm sm:text-base"
                            />
                        </div>
