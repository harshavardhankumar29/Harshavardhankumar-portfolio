    ...
    return (
        <section id="about" className="pb-12 pt-4 relative z-10 w-full">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                >
                    <div className="bg-black/50 w-12 h-12 rounded-xl flex items-center justify-center mb-4 border border-white/5 group-hover:border-white/20 transition-colors">
                ...
                <motion.div
                    ...
                    className="md:col-span-3 bg-gradient-to-r from-zinc-900/80 to-black border border-white/5 p-8 rounded-2xl flex flex-col md:flex-row items-start md:items-center justify-between group hover:border-white/20 transition-colors relative overflow-hidden"
                >
                    <div className="relative z-10 flex flex-col md:flex-row md:items-center gap-6 mb-6 md:mb-0">
                        <div className="bg-accent text-black w-14 h-14 rounded-full flex items-center justify-center group-hover:scale-105 transition-transform">
                            <Globe className="w-6 h-6" />
                        </div>
                        <div>
                            <h3 className="text-2xl font-bold mb-1 text-white">Let's work together</h3>
